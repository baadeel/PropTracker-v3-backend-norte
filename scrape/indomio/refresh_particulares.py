from db.db_properties import get_properties_indomio, add_propertie, borrar_inmuebles_todos, guardar_en_inmuebles_todos, obtener_inmuebles_todos
from .scraper_utils import scrapear_listas_de_inmuebles
import time
...
def refresh_particulares():
    ...
    try:
        lista_realdictrow = obtener_inmuebles_todos("indomio", "tenerife-norte")
    ...
    while True:
        time.sleep(4)
        ids_particulares, primeros_5, no_hay_inmuebles_nuevos, inmuebles_5_nuevos = scrapear_listas_de_inmuebles(contador_pag, primeros_5_inmuebles_db, inmuebles_5_nuevos)
        
        if contador_pag == 1:
            print(primeros_5, "hola")
        ...
        if primeros_5_inmuebles_totales and contador_pag == 1:
            ...
            borrar_inmuebles_todos("indomio", "tenerife-norte")
...
def old_properties_to_dict():
    particulares_old = get_properties_indomio()
